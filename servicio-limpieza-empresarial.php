...
<section id="slider" class="slider-element dark swiper_wrapper" data-effect="fade" data-loop="true" data-dots="true" data-speed="1000" data-autoplay="4500" style="min-height: 650px; position: relative; top: 10px;">
	...
	<div class="swiper swiper-parent">
		<div class="swiper-wrapper">
			...
			<div class="swiper-slide">
				<div class="swiper-slide-bg" style="background-image: url(assets/images/single/15.jpg);">
				</div>
	...
	<div id="page-menu-wrap">
		<div class="container">
			<div class="page-menu-row">
				...
				<div class="page-menu-title"><span>Limpieza empresarial</div>
...
<section class="py-4" id="content">
			...
			<div class="row">
				...
				============================================= -->
					<div id="section-features" class="page-section">
						...
						<p>
							Ofrecemos servicios de limpieza empresarial a medida, enfocados en mantener espacios de trabajo pulcros y profesionales. Nuestro equipo entiende la importancia de un entorno de trabajo limpio y organizado para mejorar la productividad y reflejar una imagen corporativa positiva. Nos especializamos en la limpieza de oficinas, salas de reuniones, áreas comunes y otros espacios empresariales, utilizando métodos y productos eficaces que garantizan un ambiente higiénico y atractivo sin interrumpir las operaciones diarias de su negocio.
						</p>
    ...
    <div class="row">
        <div class="col-md-6">
            <ul class="iconlist">
                <li><i class="bi-check-circle-fill"></i><span class="ms-2">Limpieza detallada de espacios de trabajo y áreas comunes</span></li>
                <li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Uso de productos de limpieza ecológicos y seguros</span></li>
                <li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Técnicas de limpieza modernas y eficientes</span></li>
                <li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Equipos profesionales y discretos</span></li>
            </ul>
        </div>
        <div class="col-md-6">
            <ul class="iconlist">
                <li><i class="bi-check-circle-fill"></i><span class="ms-2">Flexibilidad horaria para no interrumpir las operaciones comerciales</span></li>
                <li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Planes de limpieza personalizados según las necesidades del negocio</span></li>
                <li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Mantenimiento preventivo y periódico</span></li>
                <li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Compromiso con la calidad y satisfacción del cliente</span></li>
            </ul>
        </div>
    </div>
</div>
							...
							<form class="row mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post">
								...
								<div class="col-md-4 form-group">
									...
									<select id="template-contactform-service" name="template-contactform-service" class="form-select border-form-control">
										...
										<option selected value="Limpieza empresarial">Limpieza empresarial</option>
