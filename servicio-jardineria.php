	...
	<div class="swiper swiper-parent">
		<div class="swiper-wrapper">
			<div class="swiper-slide">
				<div class="swiper-slide-bg" style="background-image: url(assets/images/single/9.jpg);">
				</div>

			</div>
			<div class="swiper-slide">
				<div class="swiper-slide-bg" style="background-image: url(assets/images/single/10.jpg);">
				</div>
	...
	<div id="page-menu-wrap">
		<div class="container">
			<div class="page-menu-row">
				...
				<div class="page-menu-title"><span>Jardinería</div>
...
<section class="py-4" id="content">
			...
			<div class="row">
				...
				============================================= -->
					<div id="section-features" class="page-section">
						...
						<p>
							Nos especializamos en ofrecer servicios de jardinería de alta calidad, abarcando desde el diseño y mantenimiento de jardines residenciales hasta la gestión de espacios verdes en entornos comerciales y corporativos. Entendemos la importancia de un espacio verde bien cuidado, no solo para la estética y el valor del lugar, sino también para el bienestar y la tranquilidad que brinda a sus usuarios. Nuestro equipo combina habilidad artística con conocimientos técnicos para crear y mantener jardines que reflejen belleza, armonía y sostenibilidad.
						</p>
	...
	<div class="col-md-6">
    <ul class="iconlist">
        <li><i class="bi-check-circle-fill"></i><span class="ms-2">Diseño creativo y personalizado de jardines.</span></li>
        <li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Mantenimiento integral de áreas verdes.</span></li>
        <li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Selección de plantas adecuadas para cada espacio.</span></li>
        <li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Uso de técnicas sostenibles y respetuosas con el medio ambiente.</span></li>
    </ul>
</div>
<div class="col-md-6">
    <ul class="iconlist">
        <li><i class="bi-check-circle-fill"></i><span class="ms-2">Servicios de podado, siembra y tratamientos específicos.</span></li>
        <li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Control orgánico de plagas y enfermedades.</span></li>
        <li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Instalación y mantenimiento de sistemas de riego.</span></li>
        <li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Asesoramiento profesional y servicio personalizado.</span></li>
    </ul>
</div>
							...
							<form class="row mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post">
								...
								<div class="col-md-4 form-group">
									...
									<select id="template-contactform-service" name="template-contactform-service" class="form-select border-form-control">
										...
										<option selected value="Jardineria">Jardinería</option>
