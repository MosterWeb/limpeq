	...
	<div class="swiper swiper-parent">
		<div class="swiper-wrapper">
			<div class="swiper-slide">
				<div class="swiper-slide-bg" style="background-image: url(assets/images/single/11.jpg);">
				</div>

			</div>
			<div class="swiper-slide">
				<div class="swiper-slide-bg" style="background-image: url(assets/images/single/12.jpg);">
				</div>
	...
	<div id="page-menu-wrap">
		<div class="container">
			<div class="page-menu-row">
				...
				<div class="page-menu-title"><span>Lavado de vidrios de altura</div>
...
<section class="py-4" id="content">
			...
			<div class="row">
				...
				============================================= -->
					<div id="section-features" class="page-section">
						...
						<p>
							Nuestros servicios de limpieza en altura están diseñados para atender las necesidades de mantenimiento y lavado de vidrios de altura en edificios y estructuras complejas. Contamos con un equipo especializado y certificado en trabajos de altura, capaz de manejar desde la limpieza de fachadas de vidrio hasta el mantenimiento de superficies difíciles de alcanzar. Utilizamos equipos de seguridad avanzados y técnicas de limpieza efectivas para garantizar resultados excepcionales, asegurando la integridad y la estética de su edificio sin comprometer la seguridad.
						</p>
    ...
    <div class="row">
        <div class="col-md-6">
            <ul class="iconlist">
                <li><i class="bi-check-circle-fill"></i><span class="ms-2">Equipo especializado en técnicas de lavado de vidrios de altura.</span></li>
                <li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Uso de equipos de seguridad certificados y modernos.</span></li>
                <li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Limpieza efectiva de fachadas, ventanas y estructuras exteriores.</span></li>
                <li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Métodos adaptados a diferentes tipos de superficies y materiales.</span></li>
            </ul>
        </div>
        <div class="col-md-6">
            <ul class="iconlist">
                <li><i class="bi-check-circle-fill"></i><span class="ms-2">Cumplimiento estricto de normativas de seguridad y salud laboral.</span></li>
                <li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Servicios de inspección y mantenimiento preventivo.</span></li>
                <li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Técnicas de limpieza respetuosas con el medio ambiente.</span></li>
                <li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Compromiso con la eficiencia y minimización de molestias.</span></li>
            </ul>
        </div>
    </div>
</div>
							...
							<form class="row mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post">
								...
								<div class="col-md-4 form-group">
									...
									<select id="template-contactform-service" name="template-contactform-service" class="form-select border-form-control">
										...
										<option selected  value="Limpieza de altura">Limpieza de altura</option>
