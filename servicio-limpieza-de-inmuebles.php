	...
	<div class="swiper swiper-parent">
		<div class="swiper-wrapper">
			<div class="swiper-slide">
				<div class="swiper-slide-bg" style="background-image: url(assets/images/single/1.jpg);">
				</div>

			</div>
			<div class="swiper-slide">
				<div class="swiper-slide-bg" style="background-image: url(assets/images/single/2.jpg);">
				</div>
	...
	<div id="page-menu-wrap">
		<div class="container">
			<div class="page-menu-row">
				...
				<div class="page-menu-title"><span>Limpieza de inmuebles</div>
			...
			<div class="row">
				...
				============================================= -->
					<div id="section-features" class="page-section">
						...
						<p>Ofrecemos servicios de limpieza detallada y especializada para una variedad de espacios y establecimientos, incluyendo oficinas, bancos, centros comerciales, escuelas, laboratorios y más. Nuestro enfoque se centra en garantizar un ambiente limpio, higiénico y estéticamente agradable. Utilizamos técnicas avanzadas y productos de limpieza de alta calidad para tratar cada superficie adecuadamente, asegurando la eliminación efectiva de polvo, suciedad y gérmenes.
						</p>
				...
				============================================= -->
					<div id="section-spec" class="page-section mt-5">
						...
						<p>En el caso de oficinas, nos enfocamos en crear un espacio de trabajo ordenado y libre de distracciones que fomente la productividad. Para bancos y centros comerciales, nuestra atención se dirige hacia el mantenimiento de una imagen impecable y profesional que inspire confianza en sus clientes. Las escuelas reciben un tratamiento especial, donde priorizamos la seguridad y la salud de los estudiantes, limpiando y desinfectando a fondo para prevenir la propagación de enfermedades. En laboratorios, nuestra habilidad para manejar áreas que requieren un alto nivel de higiene y cuidado especial es de suma importancia.</p>
						<div class="row">
							<div class="col-md-6">
								<ul class="iconlist">
									<li><i class="bi-check-circle-fill"></i><span class="ms-2">Variedad de opciones de limpieza.</span></li>
									<li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Equipo profesional y capacitado.</span></li>
									<li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Uso de productos ecológicos y seguros.</span></li>
									<li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Flexibilidad de horario para minimizar interrupciones.</span></li>
								</ul>
							</div>
							<div class="col-md-6">
								<ul class="iconlist">
									<li><i class="bi-check-circle-fill"></i><span class="ms-2">Atención detallada a áreas específicas.</span></li>
									<li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Mantenimiento preventivo para prolongar limpieza.</span></li>
									<li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Servicio personalizado según necesidades del cliente.</span></li>
									<li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Compromiso con la satisfacción total del cliente.</span></li>
								</ul>
							</div>
							...
							<form class="row mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post">
								...
								<div class="col-md-4 form-group">
									...
									<select id="template-contactform-service" name="template-contactform-service" class="form-select border-form-control">
										...
										<option selected value="Limpieza Inmuebles">Limpieza de Inmuebles</option>
