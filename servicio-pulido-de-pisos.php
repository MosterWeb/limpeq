	...
	<div class="swiper swiper-parent">
		<div class="swiper-wrapper">
			<div class="swiper-slide">
				<div class="swiper-slide-bg" style="background-image: url(assets/images/single/5.jpg);">
				</div>

			</div>
			<div class="swiper-slide">
				<div class="swiper-slide-bg" style="background-image: url(assets/images/single/6.jpg);">
				</div>
	...
	<div id="page-menu-wrap">
		<div class="container">
			<div class="page-menu-row">
				...
				<div class="page-menu-title"><span>Pulido de pisos</div>
			...
			<div class="row">
				...
				============================================= -->
					<div id="section-features" class="page-section">
						...
						<p>
							Nos especializamos en ofrecer servicios de pulido de pisos, atendiendo a una variedad de necesidades y tipos de superficies, desde pisos residenciales hasta espacios comerciales y corporativos. Entendemos que cada tipo de piso tiene sus particularidades y requiere un tratamiento especializado para lograr los mejores resultados. Nuestro equipo utiliza técnicas avanzadas y equipos de última generación para asegurar un acabado perfecto, restaurando el brillo y la belleza natural de sus pisos.
						</p>
				...
				============================================= -->
					<div id="section-spec" class="page-section mt-5">
						...
						<p>Nuestro objetivo es brindar un servicio de pulido de pisos que no solo realce la belleza y durabilidad de sus superficies, sino que también garantice un acabado impecable y duradero.</p>
						<div class="row">
							<div class="col-md-6">
								<ul class="iconlist">
									<li><i class="bi-check-circle-fill"></i><span class="ms-2">Técnicas avanzadas de pulido.</span></li>
									<li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Resultado de alto brillo y duradero.</span></li>
									<li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Equipos modernos y eficientes.</span></li>
									<li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Personal experto en diversos tipos de pisos.</span></li>
								</ul>
							</div>
							<div class="col-md-6">
								<ul class="iconlist">
									<li><i class="bi-check-circle-fill"></i><span class="ms-2">Protección y mantenimiento prolongado.</span></li>
									<li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Servicio rápido y sin interrupciones.</span></li>
									<li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Métodos ecológicos y seguros.</span></li>
									<li class="mt-2"><i class="bi-check-circle-fill"></i><span class="ms-2">Satisfacción garantizada en cada servicio.</span></li>
								</ul>
							</div>
							...
							<form class="row mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post">
								...
								<div class="col-md-4 form-group">
									...
									<select id="template-contactform-service" name="template-contactform-service" class="form-select border-form-control">
										...
										<option selected value="Pulido Pisos">Pulido de Pisos</option>
